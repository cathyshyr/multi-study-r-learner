# Scenario IV
# observational studies (need to estiamte e_k)
...
save(results, perturb_tau, perturb_mu0, perturb_a, prop_overlap, num_confounders, K, n, p, file = paste0("Simulation_IV_p40_numConfounders8", ".RData"))
